...
use App\Http\Controllers\Admin\WorkAsController;
...
Route::get('/topservices',[ServiceController::class, 'TopServiceView']);
...
// Work as All Routes
Route::get('/workas',[WorkAsController::class, 'SelectAllWorkAs']);